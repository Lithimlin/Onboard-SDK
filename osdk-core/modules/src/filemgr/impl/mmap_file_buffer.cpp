...
bool
MmapFileBuffer::init(std::string path, uint64_t fileSize)
{
  ...
  fdAddr =
    (char*)mmap(NULL, fdAddrSize, PROT_READ | PROT_WRITE, MAP_SHARED, fd, 0);
...
// flag 代表是否覆盖已有队列缓存
bool
MmapFileBuffer::InsertBlock(const uint8_t* pack,
